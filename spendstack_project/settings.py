"""
Django settings for spendstack_project project.
...
SECRET_KEY = 'django-insecure-vk543s=4^l1y7f60l&=v0!o1eb69o0x^=h%n!%byarfhawilhm'
...
ROOT_URLCONF = 'spendstack_project.urls'
...
WSGI_APPLICATION = 'spendstack_project.wsgi.application'
